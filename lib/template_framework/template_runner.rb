...
%w(default authentication javascript_mvc orm testing_framework fixture_replacement code_coverage template_engine compass bootstrap cucumber pry).each do |recipe|
